 ...
 */
function createUrl(url: string, params?: Record<string, string | number | boolean | undefined>): string {
 ...
 */
async function fetchWithTimeout(url: string, options: RequestInit, timeout = API.TIMEOUT_MS): Promise<Response> {
